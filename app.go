...
func NewApp(configuration configuration.Configuration) *App {
	...
	app.register(v2.RouteNameManifestByDigest, imageManifestDispatcher)
	app.register(v2.RouteNameMarkManifest, markManifestDispatcher)
	app.register(v2.RouteNameMarkManifestByDigest, markManifestDispatcher)
